...
Diese Ergebnisse zeigen, dass Mythos zwar den aktuellen Stand der Technik im Bereich offensiver KI-Fähigkeiten definiert, der Abstand zur breit verfügbaren Modellbasis jedoch klein ist. Schon ein Leistungsdelta von rund 5\,Prozentpunkten auf Expert-Level-CTFs bedeutet, dass die folgenden Angriffsvektoren nicht auf Mythos beschränkt sind, sondern in abgeschwächter Form bereits mit öffentlich zugänglichen Modellen realisiert werden können.
...
Da öffentliche Modelle nahezu gleichwertige Fähigkeiten zu einem Bruchteil der Kosten besitzen, sind die im folgenden Kapitel beschriebenen Angriffsvektoren nicht auf Nutzer mit Zugang zu Mythos beschränkt, sondern einem breiten Täterkreis zugänglich.
